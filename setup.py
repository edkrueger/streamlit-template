...
setup(
    ...
    install_requires=[
        ...
        "importlib-metadata==3.10.1; python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0'",
        ...
        "typing-extensions==3.10.0.0; python_full_version < '3.8.0' and python_full_version < '3.8.0' and python_full_version < '3.8.0'",
        "tzlocal==2.1",
